...
class GeneralSemiCPS(GeneralSemiBase):
    ...
    def train_step(self, data, optimizer):
        ...
        sup_losses2 = self.exec_forward(self.architecture2, data["sup_data"], self.outputs2)
        outputs.update(add_prefix(self.outputs2, 'sup2'))
        sup_losses1 = self.exec_forward(self.architecture, data["sup_data"], self.outputs)
